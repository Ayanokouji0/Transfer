...
def gatys_style_transfer(net, normalization_mean, normalization_std,
                       content_img, style_img, input_img, num_steps=300,
                       style_weight=1000000, content_weight=1):
    
    model, style_losses, content_losses = get_style_model_and_losses(net,
    ...
    while epoch[0] <= num_steps:
        ...
        def closure():
            ...
            writer.add_scalar('Style Loss', style_score.item(), epoch[0])
            writer.add_scalar('Content Loss', content_score.item(), epoch[0])
...
output = gatys_style_transfer(net, net_normalization_mean, net_normalization_std,
